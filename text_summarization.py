...
def extractive_sum(text, summary_percentage=20):
    """
    Perform extractive summarization on the given text with adjustable summary size.
    
    Args:
        text (str): Input text to summarize
        summary_percentage (int, optional): Percentage of original text to include in summary. 
                                            Defaults to 20 (20% of original text length).
